Please find the source codes from

[1] WebFront : homeowner-webfront
[2] API : homeowner-service

Please use the Batch files for 
[1] mvn clean and install.
[2] mvn run is only for local testing.
